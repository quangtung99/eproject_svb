	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-7 imge_b">
				<h3 style="border-bottom: 1px solid #333333;color: red">Cá Công Gô Tetra</h3>
				<p>
					- Phân bố: Châu Phi, Công gô<br>

					- Chiều dài cá (cm): 8 <br>

					- Nhiệt độ nước (C): 23 – 28<br>
					...
					+ Tầng nước ở: Giữa<br>
					+ Sinh sản: Cá đẻ trứng phân tán, bố trí cây thủy sinh cho trứng dính, tách trứng ra khỏi cá bố mẹ sau khi đẻ<br>
