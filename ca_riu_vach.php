	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-7 imge_b">
				<h3 style="border-bottom: 1px solid #333333;color: red">Cá Rìu Vạch</h3>
				<p>
					 Tên khoa học: Marbled Hatchetfish<br>
					 Là một loài cá vùng nhiệt đới thuộc họ Gasteropelecidae.<br>
					 Có nguồn gốc ở Nam Mỹ tại Peru và giữa Amazon, Guiana và Venezuela<br>
					 Cá phát triển đến khoảng 2,5 inch (~6,5 cm).<br>
					 Nhiệt độ : 24 - 28 Độ C<br>
					 PH: 5,5 - 7.0<br>
					 Thức ăn : Cá ăn mồi nổi trên mặt nước<br>
					Khu vực sống : Cá sống ở tầng nước mặt<br>
					Sinh sản : Đẻ trứng nổi trên mặt nước<br>
					 Cá rìu vạch thường sẽ nhảy ra khỏi nước khi báo động, chúng cũng có thể nhảy để bắt côn trùng nhỏ trên không.
