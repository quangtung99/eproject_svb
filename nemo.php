	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-7 imge_b">
				<h3 style="border-bottom: 1px solid #333333;color: red">Cá Hề</h3>
				<p>
					Tên tiếng Anh : Amphiprioninae hay Clownfish<br>
					Là loài cá biển sống ở các dải đá ngầm và rạn san hô, nằm trong nhánh cá hề thuộc gia đình họ Cá thia.<br>
					 Cho đến nay ba mươi loài đã được nhận biết: một số thuộc chi Premnas, trong khi số còn lại thuộc chi Amphiprion.<br>
					  Trong tự nhiên, chúng thường sống cộng sinh với hải quỳ.<br> Tùy thuộc mỗi loài, cá hề có màu vàng, cam, đỏ nhạt, đen nhạt xen bởi các sọc trắng.<br>
					   Những cá thể lớn nhất có thể dài tới 18 xentimét (7,1 in), trong khi loài nhỏ nhất chỉ cỡ 10 xentimét (3,9 in).
