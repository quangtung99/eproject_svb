	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-7 imge_b">
				<h3 style="border-bottom: 1px solid #333333;color: red">Cá Mandarin</h3>
				<p>
					Tên khoa học: Synchiropus splendidus<br>
					Họ: Callionymidae<br>
					Xuất xứ: Ấn Độ Dương<br>
					Lần đầu tiên được tìm thấy ở vùng biển tây Thái Bình Dương năm 1976 bởi nhà sinh vật học Peters.
					Cá trạng nguyên và anh em họ gần của nó, cá Synchiropus splendidus là hai loài động vật duy nhất hiện được nhận biết là có màu xanh lam hình thành bới các sắc tố tế bào. Con đực thường to và có màu sắc sặc sỡ hơn<br>
					Cá trạng nguyên sinh sống cạnh các rạn san hô, khá kín đáo, ban ngày thường ẩn nấp, ban đêm mới ra đi kiếm bạn tình. Thức ăn là những động vật giáp xác và động vật không xương sống nhỏ.<br>
					Tính cách: Hòa bình<br>
