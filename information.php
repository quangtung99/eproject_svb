...
<html>
<head>
	<title>Information about SeaLife Tourism</title>
	<meta charset="utf-8">
	...
	<style type="text/css">
		...
		position:absolute; /* xd vi tri trong tphan */
		left:20px;
		top:5px;
		color: #fff;
		border-radius: 3px;
...
=======
	...
	<div class="container-fluid">
		<?php
            ...
            $get_values = "SELECT * FROM post_information";
            $values = mysqli_query($connect_db , $get_values);
            while ($records = mysqli_fetch_array($values , MYSQLI_ASSOC)) {
            	echo '<div class="col-sm-4">
						<div class="thumbnail">
							<a href="full-content.php?id='.$records['ID'].'" class="push-id">
								<span class="css">'.$records['TITLE'].'</span>
